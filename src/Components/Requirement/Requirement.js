...
const Requirement = ({ add }) => {
  ...
  const [data, setData] = useState({
    question1:
      "What style of images are you looking for ( ex. relax、cartoon )?",
    answer1: "",
    question2:
      "What is the purpose of generating the images? ( ex. artistic creation, design, scientific research, or some other purpose )",
    answer2: "",
  });//問題答案資料
